...
class IntelliJNotifier(project: Project, title: String, console: ConsoleViewImpl) : AsyncGUINotifier {

    companion object {

        public var map: MutableMap<Project, IntelliJNotifier> = LinkedHashMap()

        @JvmStatic
        public fun getNotifier(project: Project): IntelliJNotifier? {
            return map[project]
        }

        public fun registerNotifier(project: Project, title: String, console: ConsoleViewImpl): IntelliJNotifier {
